 ...
 */
CV_EXPORTS_W void transpose(InputArray _src, OutputArray _dst,
                            AscendStream& stream = AscendStream::Null());
 ...
 */
CV_EXPORTS_W void flip(InputArray _src, OutputArray _dst, int flipCode,
                       AscendStream& stream = AscendStream::Null());
...
@sa cv::rotate
*/
CV_EXPORTS_W void rotate(InputArray _src, OutputArray _dst, int rotateCode,
                         AscendStream& stream = AscendStream::Null());
//! @} cannops_core
